...
- Tool catalog: `export const TOOLS` in `src/mcp-tools.ts` (**109** tools at 1.4.1; re-count from
...
Version: see root `package.json` / latest `vivijure-mcp-v*` tag / `CHANGELOG.md` (**1.4.1** train).
